...
export function normalizeDeal(input: unknown): Deal {
  ...
  return {
    ...
    ownerName: readOptionalString(deal.ownerName ?? deal.businessOwnerName ?? pitch?.ownerName),
    businessOwnerName: readOptionalString(deal.businessOwnerName ?? deal.ownerName ?? pitch?.ownerName),
    investorName: readOptionalString(deal.investorName ?? bid?.investorName),
    userName: readOptionalString(deal.userName ?? deal.ownerName ?? deal.businessOwnerName ?? deal.investorName ?? pitch?.ownerName),
